...
def metodo_biseccion(a, b, tol, max_iter=100):
    ...
    print("=" * 80)
    print(f"Función: f(x) = 3 sin(0.5x) - 0.5x + 2")
...
def metodo_newton_raphson(x0, tol, max_iter=100):
    ...
    print("=" * 80)
    print(f"Función: f(x) = 3 sin(0.5x) - 0.5x + 2")
    print(f"Derivada: f'(x) = 1.5 cos(0.5x) - 0.5")
...
def graficar_funcion():
    ...
    plt.title('Gráfica de f(x) = 3 sin(0.5x) - 0.5x + 2', fontsize=14, fontweight='bold')
...
# PROGRAMA PRINCIPAL
def ejercicio_2():
    print("EJERCICIO 2 - ABIGAIL MAMANI")
    print("=" * 80)
    print("Función: f(x) = 3 sin(0.5x) - 0.5x + 2")
    print()
    tolerancia = 1e-6
